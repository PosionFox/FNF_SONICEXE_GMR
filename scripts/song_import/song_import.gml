function song_import() {
	/// Huge props to Scarlett for this one, wouldn't have been possible without her, and I mean it
	...
	ini_write_string("Song", "Vocal File", "Blammed_Voices")
	ini_write_string("Song", "Song File", "Blammed_Inst")
	ini_write_string("Song", "Name", "Blammed")
	ini_close()
}