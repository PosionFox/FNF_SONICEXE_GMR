...
draw_sprite(sprDialogPortrait, charIndex, x + portraitX + charSpriteOffset, y - 110)
...
curLetter += 0.2;
if (curLetter < string_length(selDialog)) && !(audio_is_playing(sndPixelText)) audio_play_sound(sndPixelText, 10, false);
